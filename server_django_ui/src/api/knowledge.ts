...
export const knowledgeApi = {
  ...
  // 文章：导入
  importArticle: (file: File, categoryId?: number, status?: string): Promise<ApiResponse<{ imported_count: number; errors?: string[] }>> => {
    ...
    return request.post('/api/wiki/articles/import/', formData, {
