...
_enable_loop = True
_template_filename = 'C:/2025.8/project/9/moban/server_django/studio_django_utils/code_generator/templates/django/views.mako'
...
# 生成操作列表
        ...
        if permissions_list:
            __M_writer('from studio_django_auth.utils.decorators import login_required, permission_required\n')
        __M_writer('\n\n')
